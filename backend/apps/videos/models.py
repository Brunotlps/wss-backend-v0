...
class Video(TimeStampedModel):
    ...
    title = models.CharField(_("title"), max_length=200, help_text=_("Video title"))
    ...
    file_size = models.PositiveIntegerField(
        _("file size"), default=0, help_text=_("File size in bytes")
    )
...
class Lesson(TimeStampedModel):
    ...
    title = models.CharField(_("title"), max_length=200, help_text=_("Lesson title"))
